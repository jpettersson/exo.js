(function() {
  ...
  Node = (function() {
    ...
    Node.onNodeDeactivated = function(node) {
      ...
      if (action = node.onDeactivatedAction()) return this.processAction(action);
    };
    ...
    function Node(opts) {
      var child, childrenCanActivate, id, initialState, mode, node, onActivatedAction, onDeactivatedAction, parent, smRef, __childMap, _i, _j, _len, _len2, _ref, _ref2,
        _this = this;
      if (opts == null) opts = {};
      parent = null;
      __childMap = {};
      ...
      this.childrenCanActivate = function() {
        return childrenCanActivate;
      };
      ...
      this.addChild = function(node) {
        ...
        node.setParent(this);
        return __childMap[node.nodeId()] = node;
      };
      this.removeChild = function(node) {
        return delete __childMap[node.nodeId()];
      };
      ...
      this.deactivateChildren = function() {
        var child, _k, _len3, _ref3, _results;
        _ref3 = this.children();
        _results = [];
