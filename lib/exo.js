...
(function() {
  ...
  Node = (function() {
    ...
    function Node(opts) {
      var child, childrenCanActivate, initialState, mode, node, onActivatedAction, onDeactivatedAction, parent, smRef, __childMap, __defaultChild, __nId, _i, _j, _len, _len1, _ref, _ref1,
        _this = this;
      if (opts == null) {
        opts = {};
      }
      ...
      this.setNodeId = function(nid) {
        if (parent != null) {
          parent.onChildIdUpdated(__nId, nid, this);
        }
        return __nId = nid;
      };
      if (opts.children) {
      ...
      this.onChildIdUpdated = function(oldId, newId, child) {
        delete __childMap[oldId];
        return __childMap[newId] = child;
      };
      ...
      this.setDefaultChild = function(node) {
        return __defaultChild = node;
      };
      this.defaultChild = function() {
        return __defaultChild;
      };
