...
(function() {
  var CSSTransitioner, Controller, DOMInflater, List, Model, Spine, _base, _base1, _base2, _base3,
  ...
  if (typeof Exo !== "undefined" && Exo !== null) {
    (_base1 = Exo.Spine.Modules).CSSTransitioner || (_base1.CSSTransitioner = CSSTransitioner);
  }
  ...
  DOMInflater = {
    included: function() {
      var _base2;
      return ((_base2 = (this.filters || (this.filters = {})))['before_prepare'] || (_base2['before_prepare'] = [])).push('inflateFromDOM');
    },
    inflateFromDOM: function() {
      var classNames, collection, dashifiedClassNames, elements, key, selectors, val, _ref, _ref1,
        _this = this;
      if (typeof this['deactivateAndKillOrphans'] !== 'function') {
        return;
      }
      classNames = [];
      if (this.templates) {
    ...
    inflateModel: function(el, modelClassName) {
      var attr, attributes, className, id, modelClass, targetEl, _i, _len, _ref;
      if (this.modelClass) {
      ...
      console.log('modelClass', modelClass, 'from', modelClassName);
      if (!modelClass) {
        return;
      }
  ...
  if (typeof Exo !== "undefined" && Exo !== null) {
    (_base2 = Exo.Spine).Modules || (_base2.Modules = {});
  }

  if (typeof Exo !== "undefined" && Exo !== null) {
    (_base3 = Exo.Spine.Modules).DOMInflater || (_base3.DOMInflater = DOMInflater);
  }
