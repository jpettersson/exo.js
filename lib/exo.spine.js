...
(function() {
  var CSSTransitioner, Controller, DOMInflator, List, Model, Spine, _base, _base1, _base2, _base3,
  ...
  if (typeof Exo !== "undefined" && Exo !== null) {
    (_base3 = Exo.Spine.Modules).DOMInflator || (_base3.DOMInflator = DOMInflator);
  }
