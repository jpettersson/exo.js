(function() {
  ...
  DOMInflater = {
    ...
    inflateFromDOM: function() {
      ...
      return collection = this.el.find("[data-" + className + "-id]").map(function(index, el) {
        return _this.inflateModel($(el), _this.modelClass);
      });
    },
    inflateModel: function(el, modelClass) {
      var attr, attributes, className, id, targetEl, _i, _len, _ref;
